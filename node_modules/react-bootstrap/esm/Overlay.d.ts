...
declare namespace Overlay {
    ...
    var defaultProps: {
        transition: React.ForwardRefExoticComponent<Pick<import("react-bootstrap/esm/Fade").FadeProps, React.ReactText> & React.RefAttributes<import("react-transition-group/Transition").default<any>>>;
        rootClose: boolean;
        show: boolean;
        placement: string;
    };
